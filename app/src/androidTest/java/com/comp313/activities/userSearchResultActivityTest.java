...
public class userSearchResultActivityTest {

    @Rule
    public ActivityTestRule<SplashScreenActivity> mActivityTestRule = new ActivityTestRule<>(SplashScreenActivity.class);

    @Test
    public void userSearchResultActivityTest() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.positionText), withText("Search"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.RelativeLayout")),
                                        1),
        ...
        ViewInteraction editText = onView(
                allOf(withId(com.google.android.gms.R.id.edit_text), withText("centennial"),
                        childAtPosition(
                                childAtPosition(
                                        withId(com.google.android.gms.R.id.action_bar),
                                        1),
                                0),
                        isDisplayed()));
        editText.check(matches(withText("centennial")));

        ViewInteraction relativeLayout = onView(
                allOf(childAtPosition(
                        allOf(withId(com.google.android.gms.R.id.list),
                                childAtPosition(
